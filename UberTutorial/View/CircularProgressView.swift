...
//  UberTutorial
//
//  Created by Dmytro Grytsenko on 11.02.2023.
//
...
class CircularProgressView: UIView {
    ...
    private func configureCircleLayers() {
        pulsatingLayer = circleShapeLayer(strokeColor: .clear, fillColor: .animationFillColor)
        ...
        progressLayer = circleShapeLayer(strokeColor: .animationStrokeColor, fillColor: .clear)
